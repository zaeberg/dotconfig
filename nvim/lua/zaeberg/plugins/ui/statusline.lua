    ...
    on_click = {
      ...
      callback = function()
        vim.defer_fn(function()
          require("zaeberg.plugins.ui.toggleterm").lazygit()
        end, 100)
      end,
    },
    { -- Git Branch
...
function M.diagnostics()
  local diagnostic_icons = require("zaeberg.utils.config").diagnostics_icons
  local conditions = require("heirline.conditions")
...
function M.lsp()
  ...
  return {
    ...
    { -- Copilot status
      update = { "BufEnter", "BufLeave" },
      init = function(self)
        self.copilot_enabled = require("zaeberg.utils.config").copilot_enabled
      end,
      provider = function(self)
...
function M.file_format()
  local icons = require("zaeberg.utils.config").fileformat_icons
  return {
    init = function(self)
...
function M.config()
  local this = require("zaeberg.plugins.ui.statusline")
  ...
  vim.api.nvim_create_autocmd("ColorScheme", {
    ...
    callback = function()
      local colours = require("zaeberg.plugins.ui.statusline").setup_colours()
