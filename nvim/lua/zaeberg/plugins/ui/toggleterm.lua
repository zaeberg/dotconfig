...
function M.init()
  local this = require("zaeberg.plugins.ui.toggleterm")
  local filetype_map = require("zaeberg.utils").filetype_map
  local require_args = require("zaeberg.utils").require_args
...
function M.config()
  ...
  vim.api.nvim_create_autocmd("TermOpen", {
    ...
    pattern = "term://*",
    callback = require("zaeberg.plugins.ui.toggleterm").attach,
  })
