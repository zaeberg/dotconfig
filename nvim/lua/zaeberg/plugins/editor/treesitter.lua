...
function M.init()
  local this = require("zaeberg.plugins.editor.treesitter")
...
function M.config()
  local vim_apply = require("zaeberg.utils").vim_apply
  ...
  local ensure_installed = require("zaeberg.plugins.editor.treesitter").ensure_installed
