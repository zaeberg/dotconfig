...
M.keys = {
  ...
  { "<C-a>", "copilot#Accept()", mode = "i", noremap = true, expr = true, silent = true, replace_keycodes = false },
  { "<C-x>", "copilot#Dismiss()", mode = "i", noremap = true, expr = true, silent = true },
...
function M.init()
  vim.g.copilot_enabled = require("zaeberg.utils.config").copilot_enabled
